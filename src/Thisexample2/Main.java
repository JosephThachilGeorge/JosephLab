...
public class Main {
    public static void main(String[] args) {
        ...
        Student schoolid=new Student();


        schoolid.setId(10000);

        schoolid.setRolnumber(14141);


        schoolid.getId();
        schoolid.getRolnumber();
